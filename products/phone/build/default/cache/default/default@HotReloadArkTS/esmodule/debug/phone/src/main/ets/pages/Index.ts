    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.tabBuilder.call(this, '首页', 0, { "id": 150994958, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" }, { "id": 150994957, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" });
                } });
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.tabBuilder.call(this, '资源库', 1, { "id": 150994961, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" }, { "id": 150994960, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" });
                } });
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.tabBuilder.call(this, '搜索', 2, { "id": 150994963, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" }, { "id": 150994962, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" });
                } });
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.tabBuilder.call(this, '我的', 3, { "id": 150994955, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" }, { "id": 150994954, "type": 20000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "phone" });
                } });
        }, TabContent);
        TabContent.pop();
        Tabs.pop();
