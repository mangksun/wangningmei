...
export function GridShowBuilder(name, listData, parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new GridShow(parent ? parent : this, { name, listData }, undefined, elmtId, () => { }, { page: "features/Home/src/main/ets/components/GridShow.ets", line: 6, col: 3 });
...
export class GridShow extends ViewPU {
    ...
    GridShowTitle(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.debugLine("features/Home/src/main/ets/components/GridShow.ets(20:5)", "home");
            Row.alignItems(VerticalAlign.Bottom);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125832663, "type": 40000, params: [], "bundleName": "com.example.wangningmei", "moduleName": "Home" });
            SymbolGlyph.debugLine("features/Home/src/main/ets/components/GridShow.ets(21:7)", "home");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("features/Home/src/main/ets/components/GridShow.ets(28:7)", "home");
            Text.fontSize('24vp');
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("features/Home/src/main/ets/components/GridShow.ets(55:7)", "home");
                    Column.size({ width: '100%', height: '100%' });
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Divider.create();
                    Divider.debugLine("features/Home/src/main/ets/components/GridShow.ets(56:9)", "home");
                    Divider.color(Color.Gray);
                    Divider.margin({ left: 16, right: 16 });
                }, Divider);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Grid.create();
                    Grid.debugLine("features/Home/src/main/ets/components/GridShow.ets(59:9)", "home");
                    ...
                    const forEachItemGenFunction = _item => {
                        const item = _item;
                        {
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ...
                                GridItem.debugLine("features/Home/src/main/ets/components/GridShow.ets(62:13)", "home");
                            };
                            const observedDeepRender = () => {
                                this.observeComponentCreation2(itemCreation2, GridItem);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("features/Home/src/main/ets/components/GridShow.ets(63:15)", "home");
                                    Column.clip(true);
                                    Column.width('100%');
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Image.debugLine("features/Home/src/main/ets/components/GridShow.ets(64:17)", "home");
                                    Image.width('100%');
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    // .margin({ left: '12vp' })
                                    Column.create();
                                    Column.debugLine("features/Home/src/main/ets/components/GridShow.ets(71:17)", "home");
                                    // .margin({ left: '12vp' })
                                    Column.alignItems(HorizontalAlign.Start);
                                    // .margin({ left: '12vp' })
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("features/Home/src/main/ets/components/GridShow.ets(72:19)", "home");
                                    Text.fontSize('18vp');
                                    Text.fontColor(Color.Black);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("features/Home/src/main/ets/components/GridShow.ets(78:19)", "home");
                                    // .textAlign(TextAlign.Start)
                                    Text.fontSize('13vp');
                                    // .textAlign(TextAlign.Start)
                ...
                Grid.pop();
                Column.pop();
            }, { moduleName: "Home", pagePath: "features/Home/src/main/ets/components/GridShow" });
            ...
            NavDestination.debugLine("features/Home/src/main/ets/components/GridShow.ets(54:5)", "home");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
