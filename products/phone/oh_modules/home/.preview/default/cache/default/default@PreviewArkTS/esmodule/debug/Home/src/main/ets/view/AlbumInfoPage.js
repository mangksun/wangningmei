...
export function AlbumInfoPageBuilder(listData, parent = null) {
    const __listData__ = listData;
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender, listData = __listData__) => {
            if (isInitialRender) {
                let componentCall = new AlbumInfoPage(parent ? parent : this, { listData }, undefined, elmtId, () => { }, { page: "features/Home/src/main/ets/view/AlbumInfoPage.ets", line: 6, col: 3 });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("features/Home/src/main/ets/view/AlbumInfoPage.ets(16:7)", "home");
                    Column.size({ width: '100%', height: '100%' });
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(`设置页面`);
                    Text.debugLine("features/Home/src/main/ets/view/AlbumInfoPage.ets(17:9)", "home");
                    Text.width('100%');
                    Text.fontSize(20);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.create(``);
                    Text.debugLine("features/Home/src/main/ets/view/AlbumInfoPage.ets(30:9)", "home");
                    // Text(`${JSON.stringify(this.value)}`)
                    Text.width('100%');
                    // Text(`${JSON.stringify(this.value)}`)
                    Text.fontSize(18);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("features/Home/src/main/ets/view/AlbumInfoPage.ets(36:9)", "home");
                    Button.width('50%');
                    Button.height(40);
            ...
            NavDestination.debugLine("features/Home/src/main/ets/view/AlbumInfoPage.ets(15:5)", "home");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
